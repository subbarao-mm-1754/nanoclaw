...
/** After container exit, keep collecting this long for late writes. */
export const WORKER_OUTBOUND_POST_STOP_GRACE_MS = parseInt(
  process.env.WORKER_OUTBOUND_POST_STOP_GRACE_MS || '2000',
  10,
);
